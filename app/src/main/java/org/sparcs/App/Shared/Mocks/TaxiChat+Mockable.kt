package org.sparcs.App.Shared.Mocks
...
fun TaxiChatGroup.Companion.mockList(): List<TaxiChatGroup>{
    val chats = org.sparcs.App.Domain.Models.Taxi.TaxiChat.mockList()
    ...
    for (chat in chats) {
        if (chat.type == org.sparcs.App.Domain.Models.Taxi.TaxiChat.ChatType.IN || chat.type == org.sparcs.App.Domain.Models.Taxi.TaxiChat.ChatType.OUT) {
