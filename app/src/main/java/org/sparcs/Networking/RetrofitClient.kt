...
import org.sparcs.Domain.Helpers.TaxiLocationStorage
import org.sparcs.Domain.Helpers.TaxiLocationStorageProtocol
import org.sparcs.Domain.Helpers.TokenStorage
import org.sparcs.Domain.Helpers.TokenStorageProtocol
import org.sparcs.Domain.Helpers.UserStorage
import org.sparcs.Domain.Helpers.UserStorageProtocol
import org.sparcs.Domain.Repositories.Ara.AraBoardRepository
import org.sparcs.Domain.Repositories.Ara.AraBoardRepositoryProtocol
import org.sparcs.Domain.Repositories.Ara.AraCommentRepository
import org.sparcs.Domain.Repositories.Ara.AraCommentRepositoryProtocol
import org.sparcs.Domain.Repositories.Ara.AraUserRepository
import org.sparcs.Domain.Repositories.Ara.AraUserRepositoryProtocol
import org.sparcs.Domain.Repositories.Feed.FeedCommentRepository
import org.sparcs.Domain.Repositories.Feed.FeedCommentRepositoryProtocol
import org.sparcs.Domain.Repositories.Feed.FeedImageRepository
import org.sparcs.Domain.Repositories.Feed.FeedImageRepositoryProtocol
import org.sparcs.Domain.Repositories.Feed.FeedPostRepository
import org.sparcs.Domain.Repositories.Feed.FeedPostRepositoryProtocol
import org.sparcs.Domain.Repositories.Feed.FeedUserRepository
import org.sparcs.Domain.Repositories.Feed.FeedUserRepositoryProtocol
import org.sparcs.Domain.Repositories.OTL.OTLCourseRepository
...
import org.sparcs.Domain.Repositories.OTL.OTLLectureRepositoryProtocol
import org.sparcs.Domain.Repositories.OTL.OTLTimetableRepository
import org.sparcs.Domain.Repositories.OTL.OTLTimetableRepositoryProtocol
import org.sparcs.Domain.Repositories.OTL.OTLUserRepository
import org.sparcs.Domain.Repositories.OTL.OTLUserRepositoryProtocol
import org.sparcs.Domain.Repositories.Taxi.TaxiChatRepository
import org.sparcs.Domain.Repositories.Taxi.TaxiChatRepositoryProtocol
import org.sparcs.Domain.Repositories.Taxi.TaxiReportRepository
import org.sparcs.Domain.Repositories.Taxi.TaxiReportRepositoryProtocol
import org.sparcs.Domain.Repositories.Taxi.TaxiRoomRepository
...
import org.sparcs.Domain.Repositories.Taxi.TaxiUserRepositoryProtocol
import org.sparcs.Domain.Services.AuthenticationService
import org.sparcs.Domain.Services.AuthenticationServiceProtocol
import org.sparcs.Domain.Usecases.AuthUseCase
import org.sparcs.Domain.Usecases.AuthUseCaseProtocol
import org.sparcs.Domain.Usecases.TaxiChatUseCase
import org.sparcs.Domain.Usecases.TaxiChatUseCaseProtocol
import org.sparcs.Domain.Usecases.TaxiLocationUseCase
import org.sparcs.Domain.Usecases.TaxiLocationUseCaseProtocol
import org.sparcs.Domain.Usecases.TaxiRoomUseCase
import org.sparcs.Domain.Usecases.TaxiRoomUseCaseProtocol
...
import org.sparcs.Networking.RetrofitAPI.Ara.AraBoardApi
import org.sparcs.Networking.RetrofitAPI.Ara.AraCommentApi
import org.sparcs.Networking.RetrofitAPI.Ara.AraUserApi
import org.sparcs.Networking.RetrofitAPI.AuthApi
import org.sparcs.Networking.RetrofitAPI.Feed.FeedCommentApi
import org.sparcs.Networking.RetrofitAPI.Feed.FeedImageApi
import org.sparcs.Networking.RetrofitAPI.Feed.FeedPostApi
...
import org.sparcs.Networking.RetrofitAPI.OTL.OTLTimetableApi
import org.sparcs.Networking.RetrofitAPI.OTL.OTLUserApi
import org.sparcs.Networking.RetrofitAPI.Taxi.TaxiChatApi
import org.sparcs.Networking.RetrofitAPI.Taxi.TaxiReportApi
import org.sparcs.Networking.RetrofitAPI.Taxi.TaxiRoomApi
import org.sparcs.Networking.RetrofitAPI.Taxi.TaxiUserApi
import org.sparcs.Shared.Extensions.AndroidStringProvider
import org.sparcs.Shared.Extensions.StringProvider
